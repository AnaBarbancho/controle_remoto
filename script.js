...
window.gerarModoiPhone = function () {
  console.log('Iniciando Modo iPhone...');
  ...
  // No Safari, mudar o window.location as vezes falha com Data URL. 
  // Vamos tentar abrir como uma nova aba ou escrever no documento atual.
  try {
    ...
    // Fallback: Tentar abrir em nova janela (precisa de permissão de popup)
